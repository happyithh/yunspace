...
<div class="portlet tabbable">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-database"></i>企业用户认证审核
        </div>
    </div>
            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    <div class="pull-left" style="width:50%; padding: 10px 0;">
                        <form action="?">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="用户名/手机号/邮箱/法定代表姓名" name="search_title"
                    ...
                    {if  $_data['rows']}
                        ...
                        {else}
                        <tr>
                            <td {if $_REQUEST['status']==-1}colspan="8"{else}colspan="7"{/if} style="text-align: center;font-size: 14px;font-weight: 600;">没有信息</td>
                        </tr>
                        {/if}
                        </tbody>
                    </table>
