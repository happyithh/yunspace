            ...
            <form class="form-horizontal" role="form" action="?" method="post">
                ...
                <input type="hidden" name="identity_id" value=" {$_data['id']}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="hidden-xs" style="padding-left: 90px;">
                                <img src="{$_data['hold_identity_card_img']|default:'/package/OA_Static_1.1/interface/assets/img/val_idimg.png'}" style="min-height: 100px; width: auto; display: block;">
                            </div>
                        </td>
                    </tr>
               <!-- {if !$bind_vendor}
                ...
                <tr>
                    ...
                    <td>
                        <div class="hidden-xs" style="padding-left: 90px;">
                            ...
                            <input type="text" placeholder="请输入或选择拒绝原因" class="form-control input-sm select2 tags_select2" value="" name="rejectReason"   data-values="{implode(',',$reject_reason)}" id="rejectReason">
                            </div>
                    </td>
                </tr>
                <tr >
