        ...
        <form action="?action=submit_edit" method="post" class="clearfix form-horizontal">
            <div class="form-body">
                ...
                <div class="clearfix">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div>
                                    ...
                                    <span style="font-size: 14px;color: #a94442;"> 图片比例为4:5</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-9">
                        <label class="col-md-3 control-label">活动起止时间</label>
                        <div class="col-md-2" >
                            <input type='text' class="form-control date" placeholder="请选择开始时间" name="activity_time"
                        ...
                        <div class="col-md-2" >
                            <input type='text' class="form-control date" placeholder="请选择结束时间" name="activity_end_time"
                                   value="{if !empty($info['activity_end_time'])}{date('Y-m-d',$info['activity_end_time'])}{/if}"/>
                        </div>
                    </div>
                    <div class="form-group col-md-9">
                        <label class="col-md-3 control-label">售票起止时间段</label>
                            <div class="col-md-2" >
                    ...
                    <div class="form-group col-md-9">
                        <label class="col-md-3 control-label">门票时间</label>
                        <div class="col-md-9">
                            <label class="radio-inline">
                                <input type="radio" name="is_showtime" value="0" {if $info['is_showtime']==0}checked{/if}>
                                显示

                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="is_showtime" value="1" {if $info['is_showtime']==1}checked{/if}>
                                不显示
                            </label>
                        </div>
                    </div>
                    <div class="form-group col-md-9">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr >
                                ...
                                <th  width="15%">价格
                                    <br />
                                    <label><input name="price_type" type="radio" value="1" {if $ticketlist[0]['price_is_score']!=1}checked{/if} />元 </label>
                                    <label><input name="price_type" type="radio" value="2" {if $ticketlist[0]['price_is_score']==1}checked{/if} />积分 </label>
                                </th>
                                <th  width="30%">时间(<i style="font-style: normal;color: red;">范围在活动起止时间内</i>)</th>
                                <th  width="15%">库存</th>
                                <th  width="10%">
                            ...
                            <tr class="hide">
                                ...
                                <td><input type="text" placeholder="价格/积分" class="form-control"/></td>
                                <td>
...
<script>
    $(document).ready(function () {
        ...
        {if $info['id']}
            //访问连接二维码生成
            var url = 'http://{Core::$urls['host']}/m/event_ticket/event_info?event_id={$info['id']}';
