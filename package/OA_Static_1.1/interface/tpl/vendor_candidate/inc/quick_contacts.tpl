<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label class=" col-md-2 control-label">联系人名称</label>

            <div class="col-md-10">
                <input class="form-control" placeholder="请输入联系人名称" type="text" name="data_c[username]" value="{$_data['0']['product_name']}">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" placeholder="手机或电话-例：13888888888/0218888888" name="data_c[phone]" value="{$_data['0']['phone']}">
            </div>
        </div>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                {*<option value="{$v}" {if $_data['0']['city'] == $v}selected{/if}>*}
                {*{$v}*}
                {*</option>*}
                {*{/foreach}*}
                {*<option>其他</option>*}
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" placeholder="公司名称" name="data_c[company]" value="{$_data['0']['product_name']}">
            </div>
        </div>
    </div>
</div>
