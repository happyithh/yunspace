...
{if !empty($_data['from_where'])}
    <div class="top-fixed" style="position:fixed; display:block;right:0;top:0;line-height:20px;height:100px;border: 1px solid #DDDDDD;width:200px;z-index:8888;word-wrap: break;background-color: #AAAAAA">
        来源网址:<a href="{$_data['from_where']}" target="_blank">{$_data['from_where']}</a>
    </div>
{/if}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="col-md-6" style="padding-left: 0px;width: 30%"">
                                                        <input type="text" class="form-control" name="author" placeholder="输入作者" value="{$author}">
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="create_time" placeholder="时间格式例如：2015-01-01 00:00:01">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
