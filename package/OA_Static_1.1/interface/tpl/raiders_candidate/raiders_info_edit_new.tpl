...
<div class="portlet-body" style="padding:10px 10px">
    <div class="form-body">
    <form class="form-horizontal" role="form" action="?" method="post" enctype="multipart/form-data" onsubmit="return checkSubmit()">
        ...
        <div class="tab-content clearfix">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control input-sm select2 tags_select3" value="{$_data['space_ids']}" name="data[space_ids]" >
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-2 control-label">勾选封面图</label>
                        <div class="col-md-10">
                           <a class="btn btn-info btn-sm" id="img_set_click">立即筛选</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-1">文章内容<span class="required"
                                                                    aria-required="true">*</span></label>
                    <div class="col-md-11" id="article_content">
        ...
        <div class="form-actions text-center">
            ...
            <input name="data[img_set]" id="data_img_set" value="" type="hidden"/>
...
//            },
        ...
        $("#img_set_click").on('click',function(){
            //uef5be746f6d4bddbfcf2fdc1f80d742bf    文本编辑器的 name 字段
            //uef5be746f6d4bddbfcf2fdc1f80d742bf
            var _content =  uef5be746f6d4bddbfcf2fdc1f80d742bf.getContent();
            var m,urls = [], rex = /<img.*?src=[\"|\']?(.*?)[\"|\']?\s.*?>/g;
//            m = rex.exec( _content )
            m = _content.match(rex);
            var _html = "";
            for( i in m){
                _html+="<li><label><input type='checkbox' name='_imgs'/>"+m[i]+"</label></li>";
            }
//            console.log(_html);
            $("#img_set_body").html(_html);
        });
    });
   function checkSubmit(){
       //获取选中的图片
         var _imgs =[];
       $("input[name=_imgs]:checked").each(function(){
           if($(this).next('img').attr('src')){
                _imgs.push($(this).next('img').attr('src'));
           }
       });
       if(_imgs.length !=0 && _imgs.length <3){
            alert('请您选中3张作为封面图！');
            return false;
       }
       if(_imgs.length ==3 ){
           $("#data_img_set").val(_imgs);
       }
       return true;
   }
