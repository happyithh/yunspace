    ...
    <div class="clear"></div>
                ...
                <form class="form-horizontal" role="form" action="{$_route}product_edit/submit" method="post">
                    <div class="form-group" >
                        <div class="col-md-10" >
                            <a class="btn btn-default btn-block" href="#" onclick="addCaseUrl()"><i class=" fa fa-plus pr5"></i>添加案例</a>
                            <table class="table table-striped table-bordered table-advance table-hover table-service">
                                ...
                                {/if}
                                            ...
                                            <td>
                                                <a href="?action=detail&tab=product&id={$_REQUEST['id']}&handle_type=case&product_id={$_REQUEST['product_id']}&case_id={$ev['id']}" class="btn btn-xs btn-info">编辑</a>
                                                {if $ev['status']==1}
...
<script>
    ...
    function addCaseUrl() {
            ...
            location.href = "?action=detail&tab=product&id={$_REQUEST['id']}&handle_type=case&product_id={$_REQUEST['product_id']}";
