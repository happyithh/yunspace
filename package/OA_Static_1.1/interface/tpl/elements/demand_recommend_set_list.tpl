            ...
            <table class="table table-striped table-bordered table-hover" id="data_table" style="word-break: break-all">
                ...
                {foreach $data['rows'] as $key=>$value}
                    <tr>
                        <td>
                            {if $value['set_name']}
                                <a href="?search[set]={urlencode($value['set_name'])}">{$value['set_name']}</a>
                            {else}
                                无推荐
                            {/if}
                        </td>
                        ...
                        <td>{$value['city']}</td>
                        <td> <a href="?search[phone]={$value['phone']}">{if !empty($value['demand']['联系人'])}{$value['demand']['联系人']}{else}-----{/if}</td>
                        <td><a href="?search[username]={$value['username']}">{if !empty($value['username'])}{$value['username']}{else}-----{/if}</a></td>
