...
<div class="tabbable tabbable-custom boxless">
    <ul class="nav nav-tabs">
        ...
        <li class="tab_li">
            <a href="javascript:;" data-toggle="tab">品牌案例</a>
        </li>
            ...
            {foreach $data['brand_pic'] as $k=>$v}
                <tr>
                    ...
                    <td>
                        ...
                        <input class="form-control" type="text" name="brand_pic[{$k}][name]"
                               value="{$v['name']}">
                    </td>
                    <td class="btns">
            ...
            <table class="table table-hover">
                ...
                <tr class="hidden">
                    ...
                    <td>
                        ...
                        <input class="form-control" type="text" name="brand_case[$$][case_name]" placeholder="案例标题" value="">
                    </td>
                    <td class="btns">
                        <i class="fa fa-long-arrow-up" onclick="uploader2.UploadFiles.up(this)"></i>
                        <i class="fa fa-long-arrow-down" onclick="uploader2.UploadFiles.down(this)"></i>
