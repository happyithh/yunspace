        ...
        <table class="table table-striped table-bordered table-advance table-hover">
            ...
            {foreach $contact_demand['rows'] as $k=>$v}
                <tr>
                    ...
                    <td>{$v['demand']['具体要求']}</td>
                    <td>
                        <a href="?tab=3&demand_id={$v['id']}&id={$data['id']}&recommend_type=product_set"
                           class="btn btn-xs btn-success">推荐</a>
            ...
            <div class="col-md-12" style="padding: 0px;">
                <ul class="pagination">
                    {if $contact_demand['page']['dpll']}
                        <li class="prev">
                            <a href="{$contact_demand['page']['dup']}1" title="First"><i
                                        class="fa fa-angle-double-left"></i></a>
                        </li>
                        <li class="prev">
                            <a href="{$contact_demand['page']['dup']}{$_waiting['page']['dp']-1}" title="Prev"><i
                    ...
                    {if $contact_demand['page']['dprr']}
                        <li class="next">
                            <a href="{$contact_demand['page']['dup']}{$contact_demand['page']['dp']+1}" title="Next"><i
                                        class="fa fa-angle-right"></i></a>
                        </li>
                        <li class="next">
                            <a href="{$contact_demand['page']['dup']}{$contact_demand['page']['dtp']}" title="Last"><i
