                ...
                <form action="?" method="get" class="clearfix">
                    ...
                    <div class="form-body clearfix">
                        <div class="form-group col-md-5">
                            <label class="col-md-3 control-label">百科ID</label>
                        ...
                        <div class="form-group col-md-5">
                            <label class="col-md-3 control-label">授权手机号</label>

                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm" placeholder="授权手机号"
                                       name="search[phone]" value="{$_REQUEST['search']['phone']}">
                            </div>
                        </div>
                        <div class="form-group col-md-5">
                            <label class="col-md-3 control-label">授权时间</label>
...
<div class="portlet">
    ...
    <div class="portlet-tabs" style="position:relative">
        ...
        {*<div style="float:right;margin-top:10px;margin-right:30px;color: #444444;font-size: 16px">*}
            ...
            {*<a href="?{if !empty($_REQUEST['search'])}search[level]=2&{$_data['other']['urls']}{else}search[level]=2{/if}" class="btn {if $_REQUEST['search']['level']==2}btn-success{/if} btn-default">A级</a>*}
            {*<a href="?{if !empty($_REQUEST['search'])}search[level]=1&{$_data['other']['urls']}{else}search[level]=1{/if}" class="btn {if $_REQUEST['search']['level']==1}btn-success{/if} btn-default">B级</a>*}
            ...
            <table class="table table-striped table-bordered table-hover" id="data_table" style="word-break: break-all">
                ...
                {foreach $_data['rows'] as $k=>$v}
                    <tr data-sid="{$v['id']}">
                        ...
                        <td class="list_size">
                            <a target="_blank" href="http://{Core::$urls['host']}/baike/{Func_Url::str_urlencode($v['space_name'])}">{$v['space_name']}</a>
                        </td>
                        <td class="list_none">{$v['phone']}</td>
                        <td class="list_none">{date('Y-m-d H:i:s',$v['create_time'])}</td>
                        <td>
                            <a href="?action=detail&id={$v['id']}" class="btn btn-primary btn-xs list_size"><i class="fa fa-eye"></i>详情</a>
                            {*<a href="?action=detail&space_id={$v['id']}" onclick="OperateSpacepedia.delSpacepedia(this)" data-status="-1" class="btn btn-danger btn-xs list_size"><i class="fa fa-eye"></i>删除</a>*}
                            <a href="?action=delete&id={$v['id']}"  data-status="-1" class="btn btn-danger btn-xs list_size"><i class="fa fa-eye"></i>删除</a>
                            <a href="?action=edit&id={$v['id']}" class="btn btn-info btn-xs list_size"><i class="fa fa-eye"></i>编辑</a>
                        </td>
                    </tr>
                {/foreach}
                </tbody>
