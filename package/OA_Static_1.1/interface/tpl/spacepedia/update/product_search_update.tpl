...
<div class="portlet addrConList">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-globe"></i>待更新数据
        </div>
    </div>
    {foreach $addrData as $k=>$v}
        <div class="portlet-body addrCon">
            <span class="label label-danger" style="margin-right: 15px">百科名称:</span>  {$v['space_name']}
...
//            }
    ...
    function submintAddrList() {
        ...
        $.ajax({
            type: 'post',
            url: '{$_home}space/pedia_space_update',
            data: {
                addrInfos: jsonInfo,
                action: 'update_spacepedia_submit'
            },
