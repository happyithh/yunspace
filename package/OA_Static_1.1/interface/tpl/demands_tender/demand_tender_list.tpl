        ...
        <div class="portlet-tabs">
            ...
            <div>
                <form action="?" method="get" class="clearfix">
                    ...
                    {if isset($_REQUEST['action']) && $_REQUEST['action']=='is_my'}
                        <input type="hidden" name="action" value="is_my">
                    {/if}
                    <div class="form-body clearfix">
                        <div class="form-group col-md-5">
                            ...
                            <div class="col-md-4">
                                <input type='text' class="form-control " placeholder="需求ID或者加密的编号"
                    ...
                    <div class="form-body clearfix">
                        ...
                        <div class="form-group col-md-5">
                            ...
                            <div class="col-md-4">
                                <input type='text' placeholder="请输入你要查询的手机号" class="form-control"
...
{include 'OA_Static::demands_tender/inc/demand_tender_list.inc.tpl' index=1}
