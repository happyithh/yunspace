    ...
    <div class="">
        <form action="?action=add_contact_record" method="post">
            <div class="form-group col-md-12">
                ...
                <input type="hidden" name="contact_id" value="{$_REQUEST['id']}"/>
        ...
        {foreach $_data['rows'] as $k=>$v}
            <div class="form-group col-md-12">
                ...
                <div class="clearfix message_time"><span class="pull-left">发布时间：{$v['time']}</span><span class="pull-right">{$v['admin_name']}</span></div>
            </div>
        {/foreach}
