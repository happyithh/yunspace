        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-12">
                    <input type="text" id="team_name" data-phone="{$_data['phone']}" class="form-control" name="team_name" value="{$_data['team_name']}">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-12">
                    <label class="radio-inline"><input type="radio" name="level"   {if $_data['level']==1}checked {/if} value="1">主管</label>
