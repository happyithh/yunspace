...
//        q($request);
        ...
        $event_title = $order_info['data']['event_info']['title'].",活动开始时间:".date("Y-m-d",$start_time).",门票使用时间：".$order_info['data']['ticket_info']['event_time'].",活动地址：".$order_info['data']['event_info']['addr'];
