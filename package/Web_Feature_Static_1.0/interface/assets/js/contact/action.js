...
function right(){
	...
	img[0].style.width = (img0W - 2).toString() + "px";
	
	img[1].style.height = (img1H - 1.25).toString() + "px";
	img[1].style.left = (img1L - 5.5).toString() + "px";
	img[1].style.width = (img1W - 1.25).toString() + "px";
	
	img[2].style.height = (img2H - 1.7).toString() + "px";
	img[2].style.left = (img2L - 6.6).toString() + "px";
	img[2].style.width = (img2W - 1.7).toString() + "px";
	
	img[3].style.height = (img3H + 1.6).toString() + "px";
	img[3].style.left = (img3L - 8).toString() + "px";
	img[3].style.width = (img3W + 1.6).toString() + "px";
	
	img[4].style.height = (img4H + 1.2).toString() + "px";
	img[4].style.left = (img4L - 6.6).toString() + "px";
	img[4].style.width = (img4W + 1.2).toString() + "px";
	
	img[5].style.height = (img5H + 4).toString() + "px";
	img[5].style.left = (img5L - 5.2).toString() + "px";
	img[5].style.width = (img5W + 4).toString() + "px";
...
function left(){
	...
	img[0].style.height = (img0H + 1.2).toString() + "px";
	img[0].style.left = (img0L + 5.2).toString() + "px";
	img[0].style.width = (img0W + 1.2).toString() + "px";
	
	img[1].style.height = (img1H + 1.6).toString() + "px";
	img[1].style.left = (img1L + 6.5).toString() + "px";
	img[1].style.width = (img1W + 1.6).toString() + "px";
	
	img[2].style.height = (img2H - 1.6).toString() + "px";
	img[2].style.left = (img2L + 8.2).toString() + "px";
	img[2].style.width = (img2W - 1.6).toString() + "px";
	
	img[3].style.height = (img3H - 1.2).toString() + "px";
	img[3].style.left = (img3L + 6.6).toString() + "px";
	img[3].style.width = (img3W - 1.2).toString() + "px";
	
	img[4].style.height = (img4H - 2).toString() + "px";
	img[4].style.left = (img4L + 5).toString() + "px";
	img[4].style.width = (img4W - 2).toString() + "px";
	
	img[5].style.height = (img5H + 3.9).toString() + "px";
	img[5].style.left = (img5L + 3).toString() + "px";
	img[5].style.width = (img5W + 3.9).toString() + "px";
...
function move(direction){
	...
	if(navigator.userAgent.indexOf("Firefox")>0){
        ...
        //adslim.textContent = ad[cur].slim;
	} else {
...
function reset(){
	img[0].style.width = "145px";
	img[0].style.height = "145px";
	img[0].style.left = "0px";
	
	img[1].style.width = "185px";
	img[1].style.height = "185px";
	img[1].style.left = "175px";
	
	img[2].style.width = "240px";
	img[2].style.height = "240px";
	img[2].style.left = "390px";
	
	img[3].style.width = "185px";
	img[3].style.height = "185px";
	img[3].style.left = "660px";
	
	img[4].style.width = "145px";
	img[4].style.height = "145px";
	img[4].style.left = "875px";
...
//autoplay = setInterval("move('r')",6000);
