...
<div class="content">
    ...
    <div class="enquiry-tab-body">
        <div class="enquiry-tab-body-eq">
            ...
            <div class="enquiry-con-header" style="border: 0">
                <span>一键提交文创活动需求</span>
                <span>我们将在30分钟后为您提供多份精准活动报价</span>
            </div>
            <div class="enquiry-con">
                <div class="enquiry-con-body ajax-form"  data-validate="true" >
                    <input type="hidden"  name="ip_id" value="{if $ip_id}{$ip_id}{/if}">
                    <input type="hidden"  name="active_name" value="{if $active_name}{$active_name}{/if}">
                    ...
                    <div class="enquiry-con-input" yun="product.v2.0/enquiry.js::select@click" yun-select="1">
                        ...
                        <div class="enquiry-con-input-con">
                            <input type="text" placeholder="请选择场地类型" readonly class="select" name="date_activity"  value=""/>
                            <span class="dropDown-icon ion-arrow-down-b"></span>
                        </div>
                    </div>
                    <div class="enquiry-con-input">
    ...
    <div class="enquiry-btn">
        <button yun="form-validate/form-validate.js::ajaxSubmit@click" yun-url="" yun-ajax="ip_demand_new"
