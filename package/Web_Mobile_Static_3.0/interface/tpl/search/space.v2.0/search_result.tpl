...
<div class="list-item list-item-result">
    {if count($page->getSearchResult)>0}
    <ul>
        {foreach $page->getSearchResult as $k=>$v}
        <li>
            <a href="{$_home}service_info/{$v['baike_id']}.html">
                <div class="list-item-left">
                    <img src="{Page_Site_Global::displayMedia($v['logo'],150,113)}">
                </div>
                <div class="list-item-right">
                    <p class="name"><span class="text">{if $v['baike_name']==$v['item_name']}{$v['baike_name']}{else}{$v['baike_name']}【{$v['item_name']}】{/if}</span><span class="count">指数：8</span></p>
