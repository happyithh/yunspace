$(document).ready(function(){
    ...
    $(".js-a-downup").on("click",function(){
        if($(this).hasClass("a-up")){
            $(".a-up").siblings(".search_select_section_right").css("height","26px");
            $(this).removeClass("a-up");
            $(this).parents(".search_select_section").css({'padding-bottom':'10px'});
        }else{
            $(".search_select_section").css({'padding-bottom':'10px'});
            $(".search_select_section_right").css("height","26px");
            $(".js-a-downup").removeClass("a-up");
            $(this).addClass("a-up");
            $(".a-up").siblings(".search_select_section_right").css("height","auto");
            $(this).parents(".search_select_section").css({'padding-bottom':0});
        }
    });
