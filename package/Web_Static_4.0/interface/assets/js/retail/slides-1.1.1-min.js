        ...
        return this.each(function() {
            ...
            if (b.thumb) {
                ...
                C.children(":eq(0)").children().each(function(L) {
                    var simg = a(this).find("img").attr("src");
                    ...
                    var isVideo=a(this).find("img").hasClass('videos');
                    var KVideo1='';
                    if(N.indexOf('.mp4')>0){
                         KVideo1='<li><video id="my-video" class="video-js" controls preload="auto" poster="'+simg+'"> <source src="'+N+'"type="video/mp4"><source src="'+N+'"type="video/webm"></video></li>';
                    }else{
                         KVideo1='<li><embed src="'+N+'" allowFullScreen="true" quality="high" width="1010" height="674" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash" wmode="transparent" class="emplayer"></embed></li>';
                    }
                    //console.log(N);
