...
<div class="container clearfix">
    ...
    <div class="classify_fl1">
        <div class="article-content">
            <div id="article_all" data-category="12">
                {include file="Web_Static::classify.php.v2.0/inc/inc.wenku.tpl"}
            </div>
            {*左侧加载更多按钮*}
...
<script src="js/classify.v2.0/classify_painter.js"></script>
<script src="js/classify.v2.0/article_info.js"></script>
</body>
