        ...
        <div class="content-top">
                ...
                <div class="baike-banner">
                    ...
                    <div class="baike-banner-img yun-slider" id="bannerBaike">
                        <div class="wrap clearfix">
                            ...
                            <div class="item"><img src="img/space_library/banner_1.jpg"></div>
                            <div class="item"><img src="img/space_library/banner_2.jpg"></div>
                        </div>
            ...
            <div class="side-right">
                <div class="relative bg">
                    <div class="header">一键租场地</div>
                    <input type="hidden" name="price" value="100"/>
                    <input type="hidden" name="cate" value="展览/发布会/品鉴会"/>
                    <div class="des">场地最大容量: <span id="num-person">100</span>人</div>
                    <div class="range">
                        <div class="range-content">
                            <div id="circles-slider">
                                <div class="get-range"></div>
                            </div>
                        </div>
                    </div>
                    <div class="cate">选择场地用途</div>
                    <ul class="cate-list clearfix" id="cate-list">
                        <li><a href="javascript:;" class="t1-icon active" title="展览/发布会/品鉴会">展览/发布会/品鉴会</a></li>
                        <li><a href="javascript:;" class="t2-icon" title="路演/地推">路演/地推</a></li>
                        <li><a href="javascript:;" class="t3-icon" title="生日聚会/主题派对">生日聚会/主题派对</a></li>
                        <li><a href="javascript:;" class="t4-icon" title="晚会/演出/典礼">晚会/演出/典礼</a></li>
                        <li><a href="javascript:;" class="t5-icon" title="晚会/演出/典礼">晚会/演出/典礼</a></li>
                        <li><a href="javascript:;" class="t6-icon" title="团建/拓展">团建/拓展</a></li>
                        <li><a href="javascript:;" class="t7-icon" title="快闪店/SHOWROOM">快闪店/SHOWROOM</a></li>
                    </ul>
                    <div class="go-in"><a href="javascript:;" id="rent-space" data-root="{$_root}">下一步</a></div>
                </div>
            </div>
        </div>
        <!-- 找场地-->
            ...
            <div class="search">
                <form action="/space"  method="get" class="lib_form">
                    <div class="form-input">
                        <input type="text" placeholder="搜索场地，你可以输入场地名称或者进地标进行查找" id="suggestId" name="keyword2"/>
                    ...
                    <div class="select">
                        ...
                        <ul class="more clearfix" id="city-select-map">
                            {foreach $page->cities as $k=>$v}
                                <li>
                                    <a href="javascript:;" {if  $v==$_COOKIE['city']} class="city-active"{/if}>{$v}</a>
                                    {****位置不可置换*******}
