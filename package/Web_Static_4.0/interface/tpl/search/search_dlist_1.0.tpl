        ...
        <div class="search_head">
            <div class="search_head_content">
                <form action="/search" method="get">
                    ...
                    <!--已选择的条件-->
                    <input class="search_input" name="keyword" value="{$_REQUEST['keyword']}"/>
    ...
    <div class="search_content">
              ...
              <div class="search_list">
                  ...
                  <div class="search_list_content">
                      ...
                      <div class="search_list_img">
                          <a href="{$_home}site/{$v['title']}" target="_blank">
        ...
        <div class="search_content_right_no clearfix">
            <ul class="search-no-right">
                ...
                <li>
                    <p class="search-no-right-img"><a href="{Web_Global::createRentSpaceUrl()}"><img src="css/search.v4.0/img/search-no-icon2.png"> </a></p>
                    <p class="search-no-right-title"><a href="{Web_Global::createRentSpaceUrl()}">我有场地要出租</a></p>
                    <p class="search-no-right-word">
                        <a href="{Web_Global::createRentSpaceUrl()}">
...
<div class="search-box none" id="search-code">
    ...
    <input type="hidden" name="from_type" class="from_type" value="4" >
