            ...
            <div class="header-body-form clearfix">
                <div class="header-body-input fl">
                    ...
                    <input type="text" class="keyword1 none" name="keyword" autocomplete="off"
                           placeholder="搜索场地，你可以输入场地名或者地标进行查找" >
                    <input type="text" class="keyword2 none" name="keyword" autocomplete="off"
                           placeholder="搜索场地，你可以输入场地名或者地标进行查找" id="suggestId2">
                </div>
...
<div class="home-recommend">
    <ul class="home-recommend-list clearfix">
        ...
        {* {foreach $topicRecommend as $k=>$v}
            <li>
            <a href="{$_home}topic/{$v['topic_url']}" target="_blank">
            ...
            <div class="block-top-big fl">
                <a href="{$_home}site/{Func_Url::str_urlencode($spaceData['pic_space'][0]['space_name'],1)}">
                    ...
                    <div class="block-top-big-img">
                        <img src="{Page_Site_Global::displayMedia($spaceData['pic_space'][0]['logo'],465,337)}"
                             alt="{$spaceData['pic_space'][0]['space_name']}">
                    </div>
            ...
            <div class="block-top-right fl clearfix">
                <div class="block-top-right-li">
                    <a href="{$_home}site/{Func_Url::str_urlencode($spaceData['pic_space'][1]['space_name'],1)}">
                        ...
                        <div class="block-top-right-li-img">
                            <img src="{Page_Site_Global::displayMedia($spaceData['pic_space'][1]['logo'],232,168)}"
                                 alt="{$spaceData['pic_space'][1]['space_name']}">
                        </div>
                ...
                <div class="block-top-right-li">
                    <a href="{$_home}site/{Func_Url::str_urlencode($spaceData['pic_space'][2]['space_name'],1)}">
                        <div class="cov"></div>
                        <div class="block-top-right-li-img">
                            <img src="{Page_Site_Global::displayMedia($spaceData['pic_space'][2]['logo'],232,168)}"
                                 alt="{$spaceData['pic_space'][2]['space_name']}">
                        </div>
                        <div class="com-small-title">
        ...
        <div class="block-bottom">
            <div class="block-bottom-li fl">
                <a href="{$_home}site/{Func_Url::str_urlencode($spaceData['pic_space'][3]['space_name'],1)}">
                    ...
                    <div class="block-bottom-li-img">
                        <img src="{Page_Site_Global::displayMedia($spaceData['pic_space'][3]['logo'],232,168)}"
                             alt="{$spaceData['pic_space'][3]['space_name']}">
            ...
            <div class="block-bottom-li fl">
                <a href="{$_home}site/{Func_Url::str_urlencode($spaceData['pic_space'][4]['space_name'],1)}">
                    ...
                    <div class="cov"></div>
                    <div class="block-bottom-li-img">
                        <img src="{Page_Site_Global::displayMedia($spaceData['pic_space'][4]['logo'],232,168)}"
                             alt="{$spaceData['pic_space'][4]['space_name']}">
                    </div>
                    <div class="com-small-title">
            ...
            <div class="block-bottom-li fl clearfix">
                <a href="{$_home}site/{Func_Url::str_urlencode($spaceData['pic_space'][5]['space_name'],1)}">
                    ...
                    <div class="cov"></div>
                    <div class="block-bottom-li-img">
                        <img src="{Page_Site_Global::displayMedia($spaceData['pic_space'][5]['logo'],232,168)}"
                             alt="{$spaceData['pic_space'][5]['space_name']}">
                    </div>
                    <div class="com-small-title">
