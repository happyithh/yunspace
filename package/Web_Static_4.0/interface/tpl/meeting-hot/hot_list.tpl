...
<div class="container">
    <ul class="spacelist clearfix">
        ...
        <li class="col-md-4 col-sm-6 col-xs-12">
            <h5><a href="javascript:;">墨西哥艺术中心-大厅</a></h5>
            <div class="text">上海第一家“电影会所”，拥有一个“小型电影院”和一个“数码播放厅”。</div>
            <a href="javascript:;" class="img"><img src="img/meeting/hot-item/banner-sm.jpg"></a>
            <div class="pricecont clearfix">
                ...
                <a href="javascript:" class="fr btn-shopping js-showform"></a>
            </div>
        </li>
        <li class="col-md-4 col-sm-6 col-xs-12">
            <h5>Sigma</h5>
...
<a href="javascript:;" class="banner yearbanner">
...
{include file="Web_Static::meeting-hot/form.tpl"}
