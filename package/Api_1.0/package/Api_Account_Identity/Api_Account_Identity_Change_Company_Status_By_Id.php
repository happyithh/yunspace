 ...
 */
@session_start();
class Api_Account_Identity_Change_Company_Status_By_Id extends Api
{
//    //个人身份认证信息
...
//    }
    ...
    static function changeStatus($args)
    {
        ...
        $rs = Data_Mysql_Table_Account_Identity_Company_Info::update(
        ...
        if($rs && isset($rs[0])){
            $result =self::request('success',$request,"修改成功");
            return $result;
        }else{
