 ...
 */
@session_start();
class Api_Account_Identity_Company_List extends Api
{
//    //个人身份认证信息
...
//    }
    ...
    static function getList($args)
    {
        ...
        $rs = Data_Mysql_Table_Account_Identity_Company_Info::page(0, 15, $cols, $conditions, 'ORDER BY tb1.create_time DESC',$table);//, 'account_type' => $accountType
        if($rs['rows']){
