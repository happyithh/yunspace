            ...
            <div class="tab-pane active">
                ...
                <table class="table table-striped table-bordered table-hover"
                    ...
                    <tr>
                        ...
                        {foreach $_table['title'] as $k=>$v}
                            {if $_table['title_hidden'][$k]=='list'||$_table['title_hidden'][$k]=='both'}
                                {continue}
                            {/if}
                            <th>
                                {$v}
                    ...
                    {foreach $_data['rows'] as $k=>$v}
                        <tr>
                            ...
                            {foreach $_table['title'] as $tk=>$tv}
                                {if $_table['title_hidden'][$tk]=='list'||$_table['title_hidden'][$tk]=='both'}
                                    {continue}
                                {/if}
                                <td>
                                    {if (is_numeric($v[$tk]) &&( strpos($tv,'时间') || strpos($tv,'日期')))}
                                        {date('Y-m-d H:i',$v[$tk])}
                                    {else}
                                        {$v[$tk]}
                                    {/if}
