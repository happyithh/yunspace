...
<head>
    <meta charset="utf-8"/>
    <title>Conquer | UI Features - Icons</title>
...
<li class="dropdown" id="header_notification_bar">
    <a href="ui_icons.html#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
        <i class="icon-bell"></i>
    ...
    <ul class="dropdown-menu extended notification">
        ...
        <li class="external">
            <a href="ui_icons.html#">See all notifications <i class="fa fa-angle-right"></i></a>
        </li>
    </ul>
</li>
...
<li class="dropdown" id="header_task_bar">
    ...
    <ul class="dropdown-menu extended tasks">
        ...
        <li class="external">
            <a href="ui_icons.html#">See all tasks <i class="fa fa-angle-right"></i></a>
        </li>
    </ul>
</li>
<!-- END TODO DROPDOWN -->
...
<li class="dropdown user">
    ...
    <ul class="dropdown-menu">
        ...
        <li>
            <a href="ui_icons.html#"><i class="fa fa-tasks"></i> My Tasks <span class="badge badge-success">
                        7 </span>
            </a>
        </li>
        <li class="divider">
        ...
        <li>
            ...
            <ul class="sub-menu">
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="ui_icons.html#"><i class="icon-wrench"></i> Sample Link 1</a>
                        </li>
                        <li>
                            <a href="ui_icons.html#"><i class="icon-ban"></i> Sample Link 1</a>
                        </li>
                        <li>
                            <a href="ui_icons.html#"><i class="icon-check"></i> Sample Link 1</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="ui_icons.html#"><i class="icon-question"></i> Sample Link 1</a>
                </li>
                <li>
                    <a href="ui_icons.html#"><i class="icon-rocket"></i> Sample Link 2</a>
                </li>
                <li>
                    <a href="ui_icons.html#"><i class="icon-tag"></i> Sample Link 3</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul class="sub-menu">
                <li>
                    <a href="ui_icons.html#"><i class="icon-graph"></i> Sample Link 1</a>
                </li>
                <li>
                    <a href="ui_icons.html#"><i class="icon-share"></i> Sample Link 1</a>
                </li>
                <li>
                    <a href="ui_icons.html#"><i class="icon-settings"></i> Sample Link 1</a>
                </li>
            </ul>
        </li>
        <li>
...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="ui_icons.html#">UI Features</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
    ...
    <div class="page-toolbar">
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
                <li>
                    <a href="ui_icons.html#">Action</a>
                </li>
                <li>
                    <a href="ui_icons.html#">Another action</a>
                </li>
                <li>
                    <a href="ui_icons.html#">Something else here</a>
                </li>
                <li class="divider">
                </li>
                <li>
                    <a href="ui_icons.html#">Separated link</a>
                </li>
            </ul>
        </div>
    </div>
...
<ul class="nav nav-tabs">
    <li class="active">
        <a href="ui_icons.html#tab_1_1" data-toggle="tab">
            Fontawesome Icons </a>
    </li>
    <li>
        <a href="ui_icons.html#tab_1_3" data-toggle="tab">
            Simple Line Icons </a>
    </li>
    <li>
        <a href="ui_icons.html#tab_1_2" data-toggle="tab">
            Glyphicons </a>
    </li>
</ul>
