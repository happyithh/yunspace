        ...
        <div class="portlet-tabs">
            <ul class="nav nav-tabs"
                ...
                <li style="padding: 5px 4px 0 0">
                    <div>
                        <a class="btn btn-success" href="?action=add"><i class="fa fa-plus"></i>添加一级标签</a>
                    </div>
                </li>
            </ul>
                                ...
                                <div class="tabbable tabbable-custom">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_1_1">
                                            {foreach $_tags_tree[0] as $k=>$v}
                                                {if $v eq ''}
                                                    {assign var="v" value="`$_tags_info[$k]['tags_name']`"}
                                                {/if}
                                                    <div class="col-md-12 cates"  style="background:#f4f4f4;margin-bottom: 10px;">
                                                        <h3 class="pull-left" style="line-height:40px">{$k} .
                                                            {if $_tags_info[$k]['status']==3}
                                                                <span class="label label-danger">已删除</span>
                                                            {/if}
                                                            {if $_tags_info[$k]['status']==2}
                                                                <span class="label label-warning">已隐藏</span>
                                                            {/if}
                                                            <a href="javascript:;">{$v}</a></h3>
                                                        <div class=" pull-right butt-1" style="display:none;padding-top:10px;">
                                                            <a class="btn btn-default"  href="add_son?action=add_son&ids[]={$k}" style="margin-left:5px;">
                                                                <i class="fa fa-pencil"></i>添加</a>
                                                            <a class="btn btn-default"  href="?action=edit&ids[]={$k}&type=parent_tags" style="margin-left:5px;">
                                                                <i class="fa fa-pencil"></i>编辑 </a>
                                                            {if $_tags_info[$k]['status'] !=3 }
                                                                {if $_tags_info[$k]['status']==1}
                                                                    <a class="btn btn-default" href="?action=update&ids[]={$k}&data[status]=2"  style="margin-left:5px;">
                                                                        <i class="fa fa-eye-slash"></i>隐藏 </a>
                                                                {elseif $_tags_info[$k]['status']==2}
                                                                    <a class="btn btn-default" href="?action=update&ids[]={$k}&data[status]=1"  style="margin-left:5px;">
                                                                        <i class="fa fa-eye-slash"></i>显示</a>
                                                                {/if}
                                                                <a class="btn btn-default " href="?action=update&ids[]={$k}&data[status]=3"  style="margin-left:5px;">
                                                                ...
                                                                <div class="col-md-3 col-sm-6  col-xs-12 cate" style="margin-bottom:10px;">
                                                                    <div class="col-md-12 cate cate_w"  style="background:#f4f4f4;">
                                                                        <p class="pull-left" style="line-height:40px;">{$key} .
                                                                            {if $_tags_info[$key]['status']==3}
                                                                                <span class="label label-danger">已删除</span>
                                                                            {/if}
                                                                            {if $_tags_info[$key]['status']==2}
                                                                                <span class="label label-warning">已隐藏</span>
                                                                            {/if}
                                                                            <a href="javascript:;">{$v['tags_name']}</a></p>
                                                                        ...
                                                                        <div class="">
                                                                            <div class="pull-right butt-2" style="display:none;padding-top:10px;z-index:999; position:absolute;right:0px;">
                                                                                <a class="btn btn-default btn-xs"  href="?action=edit&ids[]={$key}" style="margin-left:5px;">
                                                                                    <i class="fa fa-pencil"></i>编辑 </a>
                                                                        {if $_tags_info[$key]['status'] !=3}
                                                                            {if $_tags_info[$key]['status'] == 1}
                                                                                <a class="btn btn-default btn-xs" href="?action=update&ids[]={$key}&data[status]=2"  style="margin-left:5px;">
                                                                                    <i class="fa fa-eye-slash"></i>隐藏 </a>
                                                                            {elseif $_tags_info[$key]['status'] == 2}
                                                                                <a class="btn btn-default btn-xs" href="?action=update&ids[]={$key}&data[status]=1"  style="margin-left:5px;">
                                                                                    <i class="fa fa-eye-slash"></i>显示</a>
                                                                            {/if}
                                                                            <a class="btn btn-default btn-xs" href="?action=update&ids[]={$key}&data[status]=3"  style="margin-left:5px;">
                                                                                <i class="fa fa-trash-o"></i>删除</a>
                                                                        {else}
                                                                            <a class="btn btn-default btn-xs" href="?action=update&ids[]={$key}&data[status]=1"  style="margin-left:5px;">
                                                                                <i class="fa fa-trash-o"></i>恢复</a>
