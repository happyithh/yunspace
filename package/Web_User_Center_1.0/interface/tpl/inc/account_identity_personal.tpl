    ...
    <div class="">
        <h3 class="form-section">个人信息
            {if $__user['attr']['identity']}
                <small>(变更认证)</small>
            {/if}
            <a href="?identity_type=2" class="btn btn-info btn-sm">
                切换到企业认证
            </a>
        </h3>
        <div class="col-md-6">
            <div class="form-group">
                <label class=" col-md-4 control-label">姓名<span class="required"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input class="form-control" type="text" name="data[护照号码]" value="{$_identity['data']['身份证号码']}">
                </div>
            </div>
        </div>
        <div class="col-md-6">
