...
<div class="">
    <h3 class="form-section">公司信息
        {if $_identity['data']}
            <small>(变更认证)</small>
        {/if}
        <a href="?identity_type=1" class="btn btn-info btn-sm">
            切换到个人认证
        </a>
    </h3>
    <div class="col-md-6">
        <div class="form-group">
            <label class=" col-md-4 control-label">公司名称<span class="required"
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class=" col-md-4 control-label">公司电话<span class="required"
                                                             aria-required="true">*</span></label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class=" col-md-4 control-label">公司地址<span class="required"
                                                             aria-required="true">*</span></label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class=" col-md-4 control-label">法人代表<span class="required"
                                                             aria-required="true">*</span></label>
            ...
            <div class="col-md-8">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div>
                        ...
                        <span style="font-size: 12px;">(*单个文件的大小不超过1M)</span>
                    </div>
                </div>
            </div>
        </div>
