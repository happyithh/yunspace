...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/vendor-register-1.css">

</head>
<body>
<!--头部  -->
{include file="Web::inc/header_nav1.tpl"}
...
<div class="content">
    <div class="wrap con clearfix banner_wrap">
        <div class="register_person">
            ...
            <div class="clear"></div>
            <div class="reg_body">
                <div class="reg_page"><a href="register">用户注册</a><a href="vendor_register" style="float:right">供应商注册</a>
                </div>
                <div class="clear"></div>
                <div class="reg_form">
                    ...
                    <form action="vendor_register" method="post">
                            ...
                            <div class="container-fluid">
                                 <div class="row">
                                      ...
                                      <div class="col-md-8 right">
                                           ...
                                           <div style="float: left; width: 67%;"><input type="text" name="auth_code" class="input" style="width: 85%;"></div>
                                          {literal}
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                  <div class="col-md-4 p left">服务领域</div>
                                  <div class="col-md-8 right"><select name="category_id" id="" class="input">
                                    <option value="{Data_Config_Site::$staticConfig['space_id']}">空间预定</option>
                        ...
                        <div class="checkbox" style="padding-left: 32px; padding-right: 10px;">
                            ...
                            <label for="tnc">我已阅读并同意
                                <a href="{$_root}yunspace/agreement" target="_blank">《云SPACE供应商协议注册协议》</a></label>
                        </div>
                        <div class="form_submit">
                            ...
                            <input type="hidden" name="account_type" value="21"/>
                        </div>
                    </form>
                </div>
                </div>
