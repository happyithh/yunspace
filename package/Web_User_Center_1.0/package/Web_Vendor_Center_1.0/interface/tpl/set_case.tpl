                    ...
                    <div class="service_content">
                        <form class="form-horizontal" role="form" action="{$_route}product_edit/submit" method="post">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <a class="btn btn-default btn-block" href="{$_route}case_add?set_id={$_data['id']}&vendor_id={$vendor['id']}"><i class=" fa fa-plus pr5"></i>添加案例</a>
                                ...
                                {/if}
                                                    ...
                                                    <td>
                                                        <a href="{$_route}case_edit?set_id={$_data['id']}&case_id={$ev['id']}&vendor_id={$vendor['id']}" class="btn btn-xs btn-info">编辑</a>
                                    ...
                                    <div>
                                        <ul class="pagination">
                                            {if $_event['page']['dpll']}
                                                <li class="prev">
                                                    <a href="{$_event['page']['dup']}1" title="First"><i class="fa fa-angle-double-left"></i></a>
                                                </li>
                                                <li class="prev">
                                                    <a href="{$_event['page']['dup']}{$_event['page']['dp']-1}" title="Prev"><i class="fa fa-angle-left"></i></a>
                                                </li>
                                            {else}
                                            ...
                                            {if $_data['page']['dprr']}
                                                <li class="next">
                                                    <a href="{$_event['page']['dup']}{$_event['page']['dp']+1}" title="Next"><i class="fa fa-angle-right"></i></a>
                                                </li>
                                                <li class="next">
                                                    <a href="{$_event['page']['dup']}{$_event['page']['dtp']}" title="Last"><i class="fa fa-angle-double-right"></i></a>
                                                </li>
                                            {else}
