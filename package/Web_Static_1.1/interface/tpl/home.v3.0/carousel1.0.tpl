...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        {*</div>*}
        {*<div class="item">*}
            {*<img src="img/home.v3.0/banner.jpg" alt="...">*}
            {*<div class="carousel-caption">*}
                {*...*}
            {*</div>*}
        {*</div>*}
    ...
    <div class="range-room-bg">
        <div class="range-room ">
            <div class="range-room-con">
                <div class="r-r-p" style="width:24%;line-height: 40px">
                    我要办一场约
                </div>
                <div class="r-r-select" style="width:13%">
                ...
                <div class="r-r-p" style="line-height: 40px;">
                    的
                </div>
