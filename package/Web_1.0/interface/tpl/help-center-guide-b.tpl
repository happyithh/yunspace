            ...
            <div class="guide">
                <div class="flow">
                    <ul>
                        ...
                        <li class="pull-left" style="background: #00c3c3; color:#fff;"><a href="{$_route}guide/b.html"><div class="icon1"><i class="fa fa-suitcase m1"></i><span  style="color:#fff;">供应商加盟</span></div></a></li>
