    ...
    <div class="content1">
        ...
        <div class="pull-right nav2">
            ...
            <div class="guide">
                <div class="flow">
                    <ul>
                        <li class="pull-left" style="background: #00c3c3; color:#fff;"><a href="{$_route}guide/a.html"><div class="icon1"><i class="fa fa-user m1"></i><span style="color:#fff;">用户注册</span></div></a></li>
                ...
                <div class="guide-1">
                    <img  class="img-responsive" src="images/z1.jpg">
                    <img  class="img-responsive" src="images/z2.jpg">
                </div>
            </div>
            {/if}
        </div>
