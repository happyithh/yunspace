...
<p class="position">
    ...
    <a href="/">{$page->info['city']|default:$smarty.cookies.city}</a>&nbsp;>&nbsp; <a href="/set_list/">超值套餐</a>&nbsp;>&nbsp;<a href="/set_list/{$page->info['category_id']}">{$page->allCategory[$page->info['category_id']]}</a>&nbsp;>&nbsp;<a href="#">{$page->info['set_name']}</a>
</p>
    ...
    <div class="bty-btn-group">
        {if $page->isBegin&&!$page->isEnd }
            ...
            {*<a href="{$_root}order_booking?id={$page->id}&booking_type=2" class="btn-buy"{$key}>*}
                {*预定下单*}
            {*</a>*}
            <a href="javascript:;" class="btn-buy pre-booking" data-href="{$_root}product_set_booking?id={$page->id}">预定下单</a>
        {elseif $page->isEnd}
    ...
    <div class="content_set_left">
        ...
        <div class="content_set_guide">
            <ul>
                ...
                <li><a href="#" id="nav21">活动案例</a></li>
                <li><a href="#" id="nav31">预定须知</a></li>
            </ul>
