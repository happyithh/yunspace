    ...
    $pc.fn.extend({
        ...
        build: function () {
            ...
            this.finishAnimating({
                ...
                'clickThroughClass': this.active.parent().attr('class') || "",
            ...
            if (this.options.carousel && $.fn.jcarousel) {
                ...
                var carouselDefaults = {
                    ...
                    initCallback: function (carousel) {
                        var totalSize = jQuery(carousel.list).find('img').size();
                        jQuery(carousel.list).find('img').click(function (e, x) {
                            ...
                            var click = parseInt(jQuery(this).parents('.jcarousel-item').attr('jcarouselindex'), 10);
                            var clicked = parseInt(click / 2) + 1;
                            var last = (jQuery(this).parents('ul').find('li:last').attr('jcarouselindex') == clicked - 1) ? true : false;
                            if (!last) {
                                clicked = (clicked - 2 <= 0) ? 0 : clicked - 2;
                            }
                            clicked++;
                            if (totalSize <= 8||totalSize-click<=4) {
                                return false;
                            }
        ...
        createThumb: function (ele) {
            ...
            $.data(ele[0], 'clickThroughClass', self.parent('a').attr('class') || "");
        ...
        finishAnimating: function (data) {
            ...
            if (data.clickThrough !== "") {
                ...
                this.anchor.attr('class', data.clickThroughClass);
