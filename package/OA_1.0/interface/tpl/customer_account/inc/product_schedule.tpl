    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                ...
                <a href="?action={$_REQUEST['action']}&tab=product&id={$_REQUEST['id']}"
                                    ...
                                    <table class="table table-striped table-bordered table-advance table-hover">
                                        ...
                                        {foreach $_data as $v}
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?action=detail&tab=schedule&point=del&id={$_REQUEST['id']}&s_id={$v['id']}&product_id={$_REQUEST['product_id']}"
