...
<input type="hidden" name="supplier_id" value="{$accountInfo['vendors'][0]['id']}">
...
<script>
    $(document).ready(function () {
        var typeahead_event = new Bloodhound({
            ...
            limit: 10,
            remote: '?action=detail&id={$_REQUEST['id']}&tab={$_REQUEST['tab']}&query=%QUERY&product_id={$_REQUEST['product_id']}&set_id={$_REQUEST['set_id']}'
        });
