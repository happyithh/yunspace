...
{else}
    {$action = 'update'}
{/if}
<form class="form-horizontal" role="form" action="{$route}?action={$action}" method="post" enctype="multipart/form-data">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            ...
            <div class="form-body">
                    ...
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        ...
                        <div>
                            ...
                            <span class="fileinput-exists">重新选择</span>
                                <input type="file" name="公司LOGO" accept="image/jpeg,image/png,image/gif" value="{$_data[0]['logo']}">
                            </span>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">公司介绍</label>
