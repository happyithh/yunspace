    ...
    <div class="portlet-body">
        ...
        <ul class="nav nav-tabs">
            <li class="{if $type=='info'}active{/if}">
                <a href="?action=get_order_detail&type=info&order_no={$_order['order_no']}">预定信息</a>
            </li> {if $_order['create_time3']}
                <li class="{if $type=='contract'}active{/if}">
                <a href="?action=get_order_detail&type=contract&order_no={$_order['order_no']}">合同详情</a>
                </li>
            ...
            <li class="{if $type=='pay'}active{/if}">
                <a href="?action=get_order_detail&type=pay&order_no={$_order['order_no']}">支付详情</a>
