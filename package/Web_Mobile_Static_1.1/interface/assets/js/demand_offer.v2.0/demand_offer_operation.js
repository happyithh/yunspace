...
var operation = {
    ...
    }, CouldNotConnect: function (e) {
        var result_id = $(e).attr('data-result-id');
        var demand_id = $(e).attr('data-demand-id');
        var content = $(e).parent('div').siblings('textarea').val();
        YunSpace.api("demand/offer/match/result/update.json", {
            action: 'couldNotConnect',
            result_id: result_id,
            demand_id: demand_id,
            content: content
        }, function (data) {
