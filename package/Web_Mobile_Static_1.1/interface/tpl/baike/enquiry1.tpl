        ...
        <div class="enquiry-tab-body-eq">
            <div class="enquiry-con">
                ...
                <div class="enquiry-con-body ajax-form"  data-validate="true" >
                    <input type="hidden" name="space_id" value="{$spaceInfo['id']}">
                    <input type="hidden" name="space_name" value="{$spaceInfo['space_name']}">
                    ...
                    <div class="enquiry-con-input">
                        ...
                        <div class="enquiry-con-input-con">
                            <input type="text" value="{$spaceInfo['space_name']}" disabled>
                        </div>
                    </div>
                    <div class="enquiry-con-input">
                        <div class="enquiry-con-input-name">
                    ...
                    <div class="enquiry-con-input">
                        ...
                        <div class="enquiry-con-input-con">
                            <textarea placeholder="请填写您要咨询的其他信息" name="content" data-error="请填写活动需求"
