...
<div class="jud-rej js-pop-noaccept hide js-pop-cont">
    ...
    <div class="pop-refuse">
        ...
        <div class="btn-wrapper">
            ...
            <button class="fr btn bg-orange js-close" onclick="operation.CouldNotConnect(this)" data-demand-id="{$demand_offer['demand_id']}" data-result-id="{$result_id}">确认</button>
        </div>
    </div>
</div>
