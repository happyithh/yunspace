...
<div class="footer margin-small">
    <form action=""  yun="form-validate/form-validate.js::formSubmit" data-validate='true'>
        <div class="form_input" style="position:relative;"  yun="form-validate/form-validate.js::formSubmit" >
            ...
            <input type="text" class="input fast-phone" placeholder="手机号码" yun="form-validate/form-validate.js::typeValidate@keyup" class="fast-phone"
        ...
        <div class="form_input  background1"  style="position:relative;">
            ...
            <input type="text"  class="input col-6 " placeholder="手机验证码" style="width: 60%!important;float:left" data-validate="true"/>
            <span class="ion-close" style="position: absolute;right:32%;line-height: 50px;font-size: 20px;color:#666"></span>
        ...
        <div  class="form_btn margin-top1">
            <button type="submit"  class="form_button block background2 " style="font-size: 25px;">登&nbsp;&nbsp;录</button>
        </div>
    </form>
    <div class="link">
