...
<div class="wrapper">
    ...
    <div class="order-details">
        ...
        <ul class="order-details-cont clearfix">
            ...
            <li class="zxcd">
                <p class="name">咨询场地：</p>
                <p class="substance">奢居会-8楼露台</p>
                <a class="fr dtl" href="javascript:;">场地详情</a>
            </li>
            <li>
                <p class="name">具体要求：</p>
                <p class="substance">发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会发布会</p>
            </li>
        </ul>
