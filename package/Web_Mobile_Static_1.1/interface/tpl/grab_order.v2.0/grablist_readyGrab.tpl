...
<div class="wrapper padding-bottom-68">
    ...
    <div class="grab-comn clearfix">
        <div class="grab-comn-title clearfix">
            <div class="grab-comn-zx">
                <span class="zx">咨询</span>
                <span class="isrd">已读</span>
            </div>
            <div class="co-t clearfix">
                <p class="fl">等待抢单</p>
                <p class="fr time"><i class="icon_time"></i><span id="countdown1">还剩19分30秒</span></p>
            </div>
            <div class="co-b clearfix">
                <p class="fl">NO.123456</p>
                <p class="fr jifen">0积分</p>
            </div>
        </div>
