...
<div class="ticket-pdg15-container">
    <table cellpadding="0" cellspacing="0" class="ticket_texted_detail">
        <tr>
            <th colspan="2">草莓音乐三日欢乐票</th>
        </tr>
        <tr>
            <td class="detail-title">票号</td>
            <td>45151415465414156</td>
        </tr>
        <tr>
    ...
    <div class="ticket-btn-wrap texted-detail-btnwrap clearfix">
        <a href="{$_home}ticket/ticket_pay" class="fl ticket-btn btn-col-grey">立即购买</a>
        <a href="" class="fr ticket-btn btn-col-magenta">我的订单</a>
    </div>
</div>
</body>
</html>