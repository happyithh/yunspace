...
<header class="site_header">
    <div class="clear_float">
        ...
        <a href="/m/test_site/mating_drink_edit?space_pedia_id={$_REQUEST['space_pedia_id']}">
...
<div class="content_m mt10">
    ...
    <table class="site_attr">
        <tr>
            ...
            <td class="site_attr_content">{$data['attr'][22]}</td>
        </tr>
        <tr>
            <td class="site_attr_title">人均价格</td>
            <td class="site_attr_content">{$data['attr'][23]}元</td>
        </tr>
    </table>
</div>
