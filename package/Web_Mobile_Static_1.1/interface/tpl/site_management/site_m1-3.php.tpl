...
<div class="site_add_tag_outside" id="special_tag">
    <div {if !empty($data['data_backup']['attr']['特色标签'])}class="site_add_tag_word1"{else}class="site_add_tag_word"{/if} id="site_add_tag_word">快为你的场地添加标签吧。</div>
    <ul>
...
<div class="site_pop" id="tag_input_pop">
    ...
    <a class="site_pag_confirm tags_submit" id="tag_input_confirm">确定</a>
    <div class="clear"></div>
</div>
...
<div class="site_pop" id="tag_delete_pop">
    ...
    <a class="site_pag_confirm tags_remove" id="tag_delete_confirm">确定</a>
</div>
