...
<div class="content_m mt10">
    ...
    <div class="site_pic_t">
        ...
        <a href="test8-1#quxiao" class="site_pic_btn">取消</a>
        <div class="clear"></div>
    </div>
<div class="site_list_outside">
    <div class="site_list">
      <div class="site_pic">
        ...
        <div class="site_pic_c">
            <div class="site_pic_name">名称1</div>
            <div class="site_pic_name_c">星空广场</div>
            <div class="clear"></div>
        </div>
        <div class="site_pic_c">
      ...
      <div class="son_space_edit">
          <div class="son_delete">
             <img src="img/site_management/son_icon1.png">
          </div>
          <div class="son_up">
    ...
    <div class="site_list">
      <div class="site_pic">
        <div class="site_pic_s"><img src="img/site_management/site_pic.jpg"></div>
        <div class="site_pic_c">
            <div class="site_pic_name">名称2</div>
            <div class="site_pic_name_c">星空广场</div>
            <div class="clear"></div>
        </div>
        <div class="site_pic_c">
    ...
    <div class="site_list">
        <div class="site_pic">
            <div class="site_pic_s"><img src="img/site_management/site_pic.jpg"></div>
            <div class="site_pic_c">
                <div class="site_pic_name">名称3</div>
                <div class="site_pic_name_c">星空广场</div>
                <div class="clear"></div>
            </div>
            <div class="site_pic_c">
