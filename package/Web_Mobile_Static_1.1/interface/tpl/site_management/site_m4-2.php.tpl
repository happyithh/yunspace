    ...
    <table class="site_attr">
        <tr>
            ...
            <td class="site_attr_content1">
                <input class="site_input" placeholder="" name="data[attr][7]" value="{$data['attr'][7]}">
            </td>
        ...
        <tr>
            ...
            <td class="site_attr_content" colspan="2">
                <input class="site_input" placeholder="请输入空间吊点" name="data[attr][15]" value="{$data['attr'][15]}">
            </td>
        </tr>
        <tr>
            <td class="site_attr_title">灯具高度</td>
            <td class="site_attr_content1">
                <input class="site_input" placeholder="" name="data[attr][16]" value="{$data['attr'][16]}">
            </td>
