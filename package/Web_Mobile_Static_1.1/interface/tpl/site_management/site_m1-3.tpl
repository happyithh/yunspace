...
<div class="site_add_tag_outside" id="special_tag">
    <div class="site_add_tag_word" id="site_add_tag_word">快为你的场地添加标签吧。</div>
    <ul>
        {*<li>文体娱乐<div>&#8730;</div></li>*}
        {*<li>文体娱乐<div>&#8730;</div></li>*}
        {*<li>文体娱乐<div>&#8730;</div></li>*}
...
<div class="site_pop" id="tag_input_pop">
    ...
    <a class="site_pag_confirm" id="tag_input_confirm">确定</a>
    <div class="clear"></div>
</div>
...
<div class="site_pop" id="tag_delete_pop">
    ...
    <a class="site_pag_confirm" id="tag_delete_confirm">确定</a>
</div>
