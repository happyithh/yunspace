...
switch($type){
    //判断是个人认证还是企业认证
    case 'personal':
        Account_Identity::personalIdentity();
        break;
    case 'company':
        Account_Identity::companyIdentity();
        break;
    case 'personalsubmit':
        Account_Identity::personalSubmit();
        break;
    case 'companysubmit':
        Account_Identity::companySubmit();
        break;
    case 'personalcomplete':
        Account_Identity::personalComplete();
        break;
    case 'companycomplete':
        Account_Identity::companyComplete();
        break;
    case 'auth_code':
        Account_Identity::sendAuthCode();
        break;
        default:
            ...
            if(!empty($identityInfo['data']) ){
                switch($identityInfo['data']['status']){
                    ...
                    case 1:
                        ...
                        break;
                    case -1:
                        $IdentityStatus = "<span style='color: #ed4e2a;font-size: 16px;'>很遗憾,信息认证审核未通过！拒绝理由:".$identityInfo['data']['refuse_reason']."</span>";
                        break;
                    default:
                        break;
                }
