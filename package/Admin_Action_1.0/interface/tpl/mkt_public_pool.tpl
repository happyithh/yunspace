    ...
    <div class="portlet-tabs">
        <ul class="nav nav-tabs"
            ...
            <li style="padding: 5px 4px 0 0">
                <div>
                    <a class="btn btn-success" href="addContact"><i class="fa fa-plus"></i>添加公共联系人</a>
                </div>
            </li>
        </ul>
        <div class="clearfix"></div>
        <div>
            <form action="searchContact" method="post" class="clearfix">
...
<div class="portlet">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-comments"></i>公共联系人列表
        </div>
        {*<div class="tools">*}
            {*<a href="javascript:;" class="collapse"></a>*}
            {*<a href="table_basic.html#portlet-config" data-toggle="modal" class="config"></a>*}
                ...
                {foreach $_data['rows'] as $k=>$v}
                    <tr role="row">
                        ...
                        <td>
                            ...
                            {if $v['admin_id']==$myId}
                                <a href="contactDetails?id={$v['id']}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i>查看</a>
                                <a href="handleChangeContactInfo?id={$v['id']}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i>修改</a>
                            {/if}
