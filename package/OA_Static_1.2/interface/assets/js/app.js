...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
            ...
            if (layoutOption) {
                localStorage.theme_layout = layoutOption;
                localStorage.theme_sidebar = sidebarOption;
                localStorage.theme_header = headerOption;
                localStorage.theme_footer = footerOption;
                localStorage.theme_sidebarPos = sidebarPosOption;
            }
        }
        ...
        var setColor = function (color) {
            ...
            var css_href = $('#style_color').attr("href");
            css_href = css_href.substr(0, css_href.indexOf('themes/') + 7);
            $('#style_color').attr("href", css_href + color_ + ".css");
            localStorage.theme_color = color;
        }
        ...
        if (localStorage.theme_layout) {
            $('.layout-option', panel).val(localStorage.theme_layout);
            $('.sidebar-option', panel).val(localStorage.theme_sidebar);
            $('.header-option', panel).val(localStorage.theme_header);
            $('.footer-option', panel).val(localStorage.theme_footer);
            $('.sidebar-pos-option', panel).val(localStorage.theme_sidebarPos);
            setLayout();
        }
        if (localStorage.theme_color) {
            setColor(localStorage.theme_color);
        }
