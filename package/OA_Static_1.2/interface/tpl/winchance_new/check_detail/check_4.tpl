...
<div class="form-group clearfix">
    ...
    <div class="col-md-2 col-xs-4">
        ...
        <div class="input-group">
            <input type="text" name="grant_fee[授权费]" value="{$data['grant_fee']['授权费'][0]}" class="form-control" required min="0">
...
<div class="form-group clearfix">
    ...
    <div class="col-md-2 col-xs-4">
        ...
        <div class="input-group">
            <input type="text" name="grant_fee[搭建费]" value="{$data['grant_fee']['搭建费'][0]}" class="form-control" required min="0">
...
<div class="form-group clearfix">
    ...
    <div class="col-md-2 col-xs-4">
        ...
        <div class="input-group">
            <input type="text" name="grant_fee[道具费]" value="{$data['grant_fee']['道具费'][0]}"  class="form-control" required min="0">
...
<div class="form-group clearfix">
    ...
    <div class="col-md-2 col-xs-4">
        ...
        <div class="input-group">
            <input type="text" name="grant_fee[运营费]" value="{$data['grant_fee']['运营费'][0]}"  class="form-control" required min="0">
