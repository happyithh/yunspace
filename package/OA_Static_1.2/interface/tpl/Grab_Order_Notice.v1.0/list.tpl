...
<div class="portlet tabbable hidden">
...
<div class="portlet">
    ...
    <div class="portlet-tabs" style="position:relative">
        <div style="margin-left:10px;margin-top:10px;color: #444444;font-size: 16px">
            <a href="?action=from" class="btn btn-primary">添加公告</a>
        </div>
    </div>
    <div class="portlet-body">
            ...
            <table class="table table-striped table-bordered table-hover" id="data_table" style="word-break: break-all">
                ...
                {foreach $_data['rows'] as $k=>$v}
                    <tr>
                        ...
                        <td class="list_none">{$v['title']}</td>
                        <td class="list_none">{date("Y-m-d H:i:s",$v['create_time'])}</td>
                        <td class="list_none">
                            <a href="?action=info&id={$v['id']}" class="btn btn-primary btn-xs">查看</a>
                        </td>
