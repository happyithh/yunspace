...
<div class="portlet">
    ...
    <div class="portlet">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-database"></i>负责人信息
            </div>
        </div>
    ...
    {***************进度记录**********}
    {include "OA_Static::Demand.v2.0/inc/demand_step_record.inc.tpl"}
    {***************客户咨询**********}
    {include "OA_Static::Demand.v2.0/inc/demand_events.tpl"}
    {***************推荐记录**********}
    {include "OA_Static::Demand.v2.0/inc/demand_recommend.inc.tpl"}
    {***************联系记录***********}
    {include "OA_Static::Demand.v2.0/inc/demand_contact_record.inc.tpl"}
    {***************报价记录************}
    {include "OA_Static::Demand.v2.0/inc/demand_scheme.tpl"}
...
<script>
    $("#search_product_all").select2({
        ...
        ajax: {
            url: 'http://' + window.location.host + "/static/api/product/search/all.json?action=space",
            dataType: 'json',
